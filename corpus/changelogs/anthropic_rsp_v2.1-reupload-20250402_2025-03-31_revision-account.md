# Anthropic Responsible Scaling Policy v2.1, silent re-upload first captured 2025-04-02 (effective March 31, 2025): revision account

This file is a SILENT VARIANT of v2.1 (see manifest notes): the current file 17310f6d...pdf differs from the 1 April 2025 file 080b0037...pdf only in table-of-contents page numbers and the removal of the TOC line 'Changelog 17'. Its changelog entry is identical to that of the earlier file. No provider account of the re-upload exists (checked: RSP page, in-document changelog).

Predecessor: v2.0 (October 15, 2024).
...
Source: documents/anthropic_rsp_v2.1-reupload-20250402_2025-03-31.pdf (section heading 'Changelog', PDF pages 21-22; the entry below occupies PDF page(s) 22, printed page number(s) 18). Text verbatim (zero-width characters removed; line breaks as extracted):
...
## Announcement post
None found (checked: anthropic.com/news via the RSP page links and the reconnaissance web search; no standalone post for v2.1).

## Redline
None offered by the provider for v2.0 to v2.1 (RSP page lists 'Version 2.1' without a redline link).
