# Anthropic Responsible Scaling Policy v2.0, silent re-upload first captured 2024-11-01 (effective October 15, 2024): revision account

This file is a SILENT VARIANT of v2.0 (see manifest notes). Its own changelog entry is identical to the v2.0 file except for the v1.0 line, which reads 'RSP-2023 (aka RSP v1.0): Initial version, link here.' (hyperlink to https://www-cdn.anthropic.com/1adf000c8f675958c2ee23805d91aaade1cd4613/responsible-scaling-policy.pdf) instead of 'Initial version.' No provider account of the re-upload exists (checked: RSP page, rsp-updates captures cited in the reconnaissance record, announcement post).
...
Source: documents/anthropic_rsp_v2.0-reupload-20241101_2024-10-15.pdf (section heading 'Changelog', PDF pages 21-22; the entry below occupies PDF page(s) 21-22, printed page number(s) 17-18; the v2.0 changelog headings carry dates only, without version labels). Text verbatim (zero-width characters removed; line breaks as extracted):
